  let currentSymbol = 'EURUSD';
        ...
        function initCharts() {
            ...
            // Register custom candlestick chart
            Chart.register({
                id: 'candlestick',
                beforeDatasetsDraw(chart) {
                    ...
                    dataset.data.forEach((datapoint, index) => {
                        ...
                        const x = point.x;
                        const yHigh = chart.scales.y.getPixelForValue(datapoint.high);
                        const yLow = chart.scales.y.getPixelForValue(datapoint.low);
                        const yOpen = chart.scales.y.getPixelForValue(datapoint.open);
                        const yClose = chart.scales.y.getPixelForValue(datapoint.close);
                        
                        const color = datapoint.close >= datapoint.open ? '#00c853' : '#ff1744';
                        const width = 8;
            ...
            miniChart = new Chart(miniCtx, chartConfig);
